...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			$modal = $('<div class="modal fade" id="' + this.options.target.substr(1) + '" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-body inner"/><div class="modal-footer"><a class="btn cancel" href="#" data-dismiss="modal">否</a> <a href="#" class="btn btn-danger" data-action="1">是</a></div></div></div></div>').appendTo(this.options.appendTo).hide();
