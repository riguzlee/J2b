...
public class SinaIdGenerator {
    ...
    public SinaIdGenerator() {
        this(1344322705519L);
    }

    public SinaIdGenerator(long idepoch) {
        this(r.nextInt((int) maxWorkerId), r.nextInt((int) maxDatacenterId), 0, idepoch);
    }

    public SinaIdGenerator(long workerId, long datacenterId, long sequence) {
        this(workerId, datacenterId, sequence, 1344322705519L);
    }

    //
    public SinaIdGenerator(long workerId, long datacenterId, long sequence, long idepoch) {
    ...
    public static void main(String[] args) {
        SinaIdGenerator s = new SinaIdGenerator();
        System.out.println(System.currentTimeMillis());
        Date d = new Date(1344322705519L);
